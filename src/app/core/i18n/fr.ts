  ...
  data: {
    AUTH: {
      LOGIN: {
        ...
        CRED: 'Ou connecter avec vos identifiants',
        REMEMBER: 'Se rappeler de moi',
        SIGININ: 'Se connecter',
        FAILURE: 'Votre login ou le mot de passe est incorrect.',
        PASSWORD: {
          FORGOT: 'Mot de passe oublier?',
          RECUP: 'Récupérez votre mot de passe en entrant votre email dans la champ ci-dessous.',
          SEND: 'Envoyez',
